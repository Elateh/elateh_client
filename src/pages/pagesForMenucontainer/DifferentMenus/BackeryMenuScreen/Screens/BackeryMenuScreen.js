  ...
  const [arrayOfPizerias, setArrayOfPizerias] = useState([
    {
      pizeriaName: `   Ваш
ЛАВаш`,
      imageSource: require("../images/1BackeryImage.png"),
      imageUnderImageSource: require("../images/downRingImage.png"),
    },
    {
      pizeriaName: `TRUSTPIZZA
& BURGERS`,
      imageSource: require("../images/2BackeryImage.png"),
      imageUnderImageSource: require("../images/downRingImage.png"),
    },
    {
      pizeriaName: "ФІШКА",
      imageSource: require("../images/3BackeryImage.png"),
      imageUnderImageSource: require("../images/downRingImage.png"),
    },
    {
      pizeriaName: `Kebab
 Story`,
      imageSource: require("../images/4BackeryImage.png"),
      imageUnderImageSource: require("../images/downRingImage.png"),
    },
    {
      pizeriaName: `   Ваш
            ...
            <React.Fragment>
              ...
              <View style={{ marginTop: 40 }}>
                <View style={styles.headView}>
                  <Image
                    source={require("../images/croissantImage.png")}
                    style={{
                      marginLeft: 30,
                      width: 83,
                      height: 83,
                  ...
                  >
                    <Text style={styles.headText}>Випічка</Text>
                  </View>

                  <Image
                    source={require("../images/donutImage.png")}
                    style={{
                      marginLeft: 30,
                      width: 83,
                      height: 83,
...
export default BackeryMenuScreen;
